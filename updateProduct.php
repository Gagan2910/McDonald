...
<?php
	...
	echo "product price = ".$pprice;

	
echo "<h3> Are you sure you want to update the product information ? </h3>";

echo "<a href=confirmUpdate.php?productID=$pid&productName=$pname&productPrice=$pprice> Y E S </a>  <br> <br>";

echo "<editProducts.php> N O </a> <br><br>"; 
