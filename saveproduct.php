...
$query="insert into tblproducts values('$pid', '$pname','$pdesc','$pprice','$pimage')";


$rowsAffected=mysqli_query($connection,$query);
echo "Product Successfully Saved in database<br>";
echo "Click on' <a href=editProducts.php>login</a>'";
